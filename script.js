...
if (contactForm) {
  contactForm.addEventListener('submit', function (e) {
    ...
    .then(data => {
      if (data.success || data.ok || (data.message && data.message.toLowerCase().includes('success'))) {
    ...
    .catch((error) => {
      ...
      btn.innerHTML = `<i class="fas fa-exclamation-triangle"></i><span style="font-size:0.8rem">Failed: Try again</span>`;
